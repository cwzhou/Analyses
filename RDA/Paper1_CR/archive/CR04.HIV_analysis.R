...
############################################################
# enter dataset_name
dataset_name = "HIV_analysis"
# code for reading in data
hiv <-read.table("/Users/zhou/Desktop/UNC_BIOS_PhD/DissertationPhD/Literature/SurvivalPM/CR/2.kxz026-suppl_data/PMCRcode-master/pseudoHIV.txt",head=TRUE)
data = hiv %>%
...
############################################################
skip.PMCR = FALSE
t0_crit = 600 #2200 # six-year survival
pooled1 = TRUE # stratified = lower nodesize; pooled = can have larger nodesize
covariates = c("Age", "Gender", "Black", "GC")
tau = 2000
K = 1 # number of CV
...
source("0_simulations/F02.ComparatorMethod_Functions.R")
