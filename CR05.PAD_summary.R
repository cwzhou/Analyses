...
mthd0 = c("CZMK", "CSK", "PMCR", "AIPWE", "ZOM", "observed")
labs0 = c("itrSurv", "dtrSurv (2023)", "PMCR (2021)", "AIPWE (2021)",
         "zero-order model", "observed")
cols0 <- c("#614CFF", "#00BFC9", "#F8766D", "#00BA38", "#FFA500", "#800040")
names(cols0) = labs0

keep_method <- c(TRUE,TRUE,TRUE,TRUE,TRUE,TRUE);
