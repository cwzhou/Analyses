...
# default settings
default <- list(n.eval = 10000, n.sim = 200, tau = 10, n.stages = 2)
default <- list(n.eval = 2, n.sim = 1, tau = 10, n.stages = 1)
...
size <- list(small.sample.size = list(n = 3),
             large.sample.size = list(n = 5))
...
betas <- list(
  beta1 =
    list(beta.hazard0 = c(0, -1, c(1,1,1)),              # (int), surv.prev, covariate (1~5)
         beta.hazard1 = c(0, -3, c(2,2,1)),              # (int), surv.prev, covariate (1~5)
         beta.censor0 = c(-3, 0.1, 0.2 * c(1,1,1)),      # (int), surv.prev, covariate (1~5)
         beta.censor1 = c(-3, 0.2, 0.2 * c(1,1,1))),     # (int), surv.prev, covariate (1~5)
  beta2 =  # moderate censoring rate
    list(beta.hazard0 = c(0, -1, c(1,1,1)),              # (int), surv.prev, covariate (1~5)
         beta.hazard1 = c(0, -3, c(2,2,1,-1,-1)),              # (int), surv.prev, covariate (1~5)
         beta.censor0 = c(-2, 0.1, 0.2 * c(1,1,1)),      # (int), surv.prev, covariate (1~5)
         beta.censor1 = c(-2, 0.2, 0.2 * c(1,1,1))),     # (int), surv.prev, covariate (1~5)
