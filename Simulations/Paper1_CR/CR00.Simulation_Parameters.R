...
if (endpoint == "CR"){
  ...
  if (default$generate_failure_method == "simple_exp"){
    ...
    if (sensitivity == 1){
      stop("generate_failure_method should be fine_gray if sensitivity = 1 to replicate results in paper.")
    } else{
      # currently using runif covariates
      betas <- list(
        beta1 = list(
          ...
          beta2.hazard0 = c(0, 1,-0.1,0.4),
          beta2.hazard1 = c(0, 1.2, 0.2,-1)),
        
        # 6 covariates
        beta2 = list(
          beta1.hazard0 = c(0,-0.5,-1.2,1.5,0.1,0.6), 
          beta1.hazard1 = c(0,0.3,-0.4,-0.2,0.9,1.6), 
          beta2.hazard0 = c(0,-0.6,1.4,1.5,2,1), 
          beta2.hazard1 = c(0,1.5,-2.1,-0.8,0.1,1)) 
      )
    }
    ...
    if (sensitivity == 1){
      ...
      betas <- list(
        beta1 = list(
          beta1.hazard0 = c(0,0.1,0.3),
          beta1.hazard1 = c(0,-1.8,-1.5),
          beta2.hazard0 = c(0,-1.1,-0.3),
          beta2.hazard1 = c(0,-0.2,1.2)),
        beta2 = list(
          beta1.hazard0 = c(0,1,1.3,-0.2,0.6,0.3,2.1,0.5,-0.3,1.4,3),
          beta1.hazard1 = c(0,-1.2,-0.1,-0.5,-1.2,-2.2,1.2,-0.1,0.5,-0.2,-1.2),
          beta2.hazard0 = c(0,-0.5,-0.5,-1.4,-1.1,0.8,1.4,-2.4,-1.1,-0.8,-0.4),
