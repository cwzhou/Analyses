...
if (endpoint == "RE"){
  ...
  betasR <- list(
    betaR1 = list(
      betaR.hazard0 = c(log(1.1), log(1), log(0.9), log(1), log(1)), #beta.hazard0 = c(log(0.8), log(3.9), log(0.2), log(0.05), log(1.1)), #c(log(1.8), log(1.9), log(1.2), log(1.5), log(1.1)),  # Covariate effects for Treatment 0 (5 parameters)
  ...
  omegaD <- list(
    omegaD1 = list(
      ...
      omegaD.hazard1 = log(0.9) #log(3.5)   # Treatment 1 survival effect
    ),
